...
public class CommunityFragment extends Fragment {
    ...
    private void initRecyclerView(final View view) {
        mRecyclerView = (RecyclerView) view.findViewById(R.id.commRecyclerView);
    ...
    private void instaAPICall() {
        ...
        String url = "https://api.instagram.com/v1/tags/theadventuredads/media/recent?access_token=7309771784.8bca4b4.8699a750c408415282a19a5214953605";
